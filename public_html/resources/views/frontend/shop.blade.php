        ...
        <main class="page-shop">
            ...
            <div class="breadcrumbs">
                <ul class="breadcrumbs-list grid wide">
                    ...
                    <li class="breadcrumbs-item">
                        <a href="{{ route('categoryFrontend.sortFollowCategoryName', [$getCategories->id]) }}" class="breadcrumbs-link">
                            {{ $getCategories->name }}
                        </a>
                    </li>       
                </ul>
                                            ...
                                            <div class="filter-options-item">
                                                ...
                                                <div class="filter-options-content">
                                                     @if (!empty($sort))
                                                        <ul class="filter-options-content__list">
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' => $sort, 'priceFrom' => '0', 'priceTo' => '5000000']) }}" id="priceFilter1" class="filter-options-content__link">
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' => $sort, 'priceFrom' => '5000000', 'priceTo' => '10000000']) }}" id="priceFilter2" class="filter-options-content__link">
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' => $sort, 'priceFrom' => '10000000', 'priceTo' => '15000000']) }}" id="priceFilter3" class="filter-options-content__link">
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' => $sort, 'priceFrom' => '15000000']) }}" id="priceFilter4" class="filter-options-content__link">
                                                                    lớn hơn 
                                                                    <span class="price">15.000.000 VND</span>
                                                                </a>
                                                            </li>
                                                    ...
                                                    @else
                                                        <ul class="filter-options-content__list">
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'priceFrom' => '0', 'priceTo' => '5000000']) }}" id="priceFilter1" class="filter-options-content__link">
                                                                    <span class="price">0</span>
                                                                    -
                                                                    <span class="price">5.000.000 VND</span>
                                                                </a>
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'priceFrom' => '5000000', 'priceTo' => '10000000']) }}" id="priceFilter2" class="filter-options-content__link">
                                                                    <span class="price">5.000.000</span>
                                                                    -
                                                                    <span class="price">10.000.000 VND</span>
                                                                </a>
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'priceFrom' => '10000000', 'priceTo' => '15000000']) }}" id="priceFilter3" class="filter-options-content__link">
                                                                    <span class="price">10.000.000</span>
                                                                    -
                                                                    <span class="price">15.000.000 VND</span>
                                                                </a>
                                                            ...
                                                            <li class="filter-options-content__item">
                                                                <a href="{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'priceFrom' => '15000000']) }}" id="priceFilter4" class="filter-options-content__link">
                                                                    lớn hơn 
                                                                    <span class="price">15.000.000 VND</span>
                                                                </a>
                                                            </li>
                                    ...
                                    <div class="filter-options-content">
                                        <ul class="filter-options-content__list">
                                            @foreach ($listBrands as $listBrand)
                                                <li class="filter-options-content__item">
                                                    <a href="{{ route('categoryFrontend.sortFollowCategoryName' , [
                            ...
                            @if ($priceFrom >= 0)
                                <script>
                                    function sort() {
                                        ...
                                        if(sort == 'desc'){
                                            let trashPHP = "{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' =>'desc', 'priceFrom' => $priceFrom, 'priceTo' => $priceTo]) }}"
                                            let del_trash_php=trashPHP.replace(/amp;/g, '');
                                            location.href = del_trash_php;
                                        } else {
                                            let trashPHP = "{{ route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' =>'asc', 'priceFrom' => $priceFrom, 'priceTo' => $priceTo]) }}"
                                            let del_trash_php=trashPHP.replace(/amp;/g, '');
                                            location.href = del_trash_php;
                                        }
                                    }
                            ...
                            @else
                                <script>
                                    function sort() {
                                        var sort = document.getElementById("sort").value;
                                        if(sort == 'desc'){
                                            location.href =  "{{route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' =>'desc'])}}"
                                        } else {
                                            location.href =  "{{route('categoryFrontend.sortFollowCategoryName' ,  ['categoryId' => $getCategories->id, 'sortByPrice' =>'asc'])}}"
                                        }
